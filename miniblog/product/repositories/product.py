...
class ProductRepository:
    ...
    def update(self, producto: Product, nombre: str, descripcion: str, precio: float, stock: int, categoria: Category) -> Product:
        if int(stock) < 0:
            raise(ValueError('Stock ingresado inválido.'))
